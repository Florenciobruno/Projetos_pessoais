...
def criar_usuario(usuario):
    CPF = input ("informe o CPF com 11 digitos: ")
    ...
    endereco = input("Informe o endereço completo(rua, numero, complemento, cidade e estado): ")
    
    usuarios.append({"nome": nome, "data de nascimento": data_de_nascimento, "CPF": CPF, "endereço": endereco})
    
    print("Usuário criado com suceso.")
...
def criar_conta(agencia, numero_da_conta, usuario):
    ...
    print("\n ----------Usuário não Encontrado, reinicie a criação da conta----------")
